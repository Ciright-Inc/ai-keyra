...
/** ai.keyra.ie — this AOTI marketing site. */
export function keyraAiAotiUrl(): string {
  return trimSlash(process.env.NEXT_PUBLIC_SITE_URL?.trim() || "https://ai.keyra.ie");
}
...
export function getKeyraEcosystemAppLinks(): KeyraEcosystemAppLink[] {
  return [
    ...
    },
    {
      id: "ai-aoti",
      label: "AI / AOTI",
      description: "Autonomous operational trust",
      href: keyraAiAotiUrl(),
    },
    {
      id: "platform",
...
/** Full app directory — static fallback when CMS launcher API is unavailable. */
export function getKeyraAdminAppLinks(): KeyraEcosystemAppLink[] {
  return [
    ...
    { id: "info", label: "Info", description: "Information hub", href: "https://info.keyra.ie" },
    {
      id: "family-office",
      label: "Family Office",
      description: "Family office portal",
      href: "https://family-office.keyra.ie",
    },
    ...
    {
      id: "jione-documents",
      label: "Jione Documents",
      description: "Documents workspace",
      href: "https://jione-documents.keyra.ie",
    },
    {
      id: "authenticator",
      label: "Authenticator",
      description: "Authenticator app",
      href: "https://authenticator.keyra.ie",
    },
    ...
    { id: "partners", label: "Partners", description: "Partner programs", href: keyraPartnersUrl() },
  ];
}
